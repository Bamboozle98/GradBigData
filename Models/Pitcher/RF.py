...
pred_df.to_csv(r"C:\Users\cbran\PycharmProjects\GradBigData\Models\Pitcher\Results\predictions_random_forest.csv", index=False)
...
summary_df.to_csv(r"C:\Users\cbran\PycharmProjects\GradBigData\Models\Pitcher\Results\random_forest_summary.csv", index=False)
...
importance_df.to_csv(r"C:\Users\cbran\PycharmProjects\GradBigData\Models\Pitcher\Results\rf_feature_importance.csv", index=False)
...
# Save the figure
plt.savefig(r"C:\Users\cbran\PycharmProjects\GradBigData\Models\Pitcher\Results\rf_feature_importance.png", dpi=300)
