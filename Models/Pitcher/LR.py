...
pred_df.to_csv(r"C:\Users\cbran\PycharmProjects\GradBigData\Models\Pitcher\Results\predictions_linear_regression.csv", index=False)
...
summary_df.to_csv(r"C:\Users\cbran\PycharmProjects\GradBigData\Models\Pitcher\Results\linear_regression_summary.csv", index=False)
...
# Save to CSV
coef_df.to_csv(r"C:\Users\cbran\PycharmProjects\GradBigData\Models\Pitcher\Results\lr_coefficients.csv", index=False)
...
# Save the figure
plt.savefig(r"C:\Users\cbran\PycharmProjects\GradBigData\Models\Pitcher\Results\lr_coefficients_plot.png", dpi=300)
