...
df = pd.read_csv(r"C:\Users\cbran\PycharmProjects\GradBigData\Data\mlb_pitchers_with_salary_2024.csv")
...
feature_scores.to_csv(r"C:\Users\cbran\PycharmProjects\GradBigData\Models\Pitcher\Results\feature_importance_rf.csv", index=False)
...
pred_df.to_csv(r"C:\Users\cbran\PycharmProjects\GradBigData\Models\Pitcher\Results\predictions_neural_network.csv", index=False)
...
summary_df.to_csv(r"C:\Users\cbran\PycharmProjects\GradBigData\Models\Pitcher\Results\neural_network_summary.csv", index=False)
print("📊 Saved summary to neural_network_summary.csv")

model.save(r"C:\Users\cbran\PycharmProjects\GradBigData\Models\Pitcher\ModelSaves\nn_Pitcher_model.keras")
print("💾 Saved model to nn_Pitcher_model.keras")
...
score_df.to_csv(r"C:\Users\cbran\PycharmProjects\GradBigData\Models\Pitcher\Results\nn_feature_weight_scores.csv", index=False)
...
plt.tight_layout()
plt.savefig(r"C:\Users\cbran\PycharmProjects\GradBigData\Models\Pitcher\Results\nn_feature_weight_scores.png", dpi=300)
